$(document).ready(function () {
  var table = $("#lplpo").DataTable({
    ...
    responsive: true,
    columnDefs: [
      { searchable: false, orderable: true, responsivePriority: 1, targets: 0 },
      { searchable: false, orderable: true, responsivePriority: 2, targets: 1 },
      { searchable: false, orderable: true, responsivePriority: 9, targets: 2 },
      {
        searchable: false,
        orderable: true,
  ...
  $("#lplpo tbody").on(
    ...
    function () {
      ...
      var columnName = $input.hasClass("input-PENERIMAAN")
        ? "PENERIMAAN"
        : "PERMINTAAN";
      var value = $input.val();
      ...
      if (existingEntry) {
        existingEntry[columnName] = value;
      } else {
        var newData = {
          DT_RowId: rowId, // Store the row ID
          PENERIMAAN: columnName === "PENERIMAAN" ? value : null,
          PERMINTAAN: columnName === "PERMINTAAN" ? value : null,
        };
